...
APT 322 @ 701 SW 7th Street {\large\textperiodcentered} Corvallis {\large\textperiodcentered} Oregon 97333\\ % Your mailing address
{\Large\Letter} steelee@onid.oregonstate.edu {\Large\Telefon} (925) 914-7826 \\
...
A technical occupation wherein Free and Open Source technologies are extensively utilized and developed with special preferences toward open hardware, network technologies and web development. Additionally, one seeking to educate with regards to Computer Sciences and FOSS.
...
Details& Works with embedded Linux systems to support different types of hardware, including building kernels through complex management systems such as the Yocto project. Extensively worked with the Minnowboard open hardware development platform, developing userspace Python drivers for various hardware components and developing materials for the maker-centric community.
\end{tabularx}

\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{June 2014 --- March 2015}\\
\gray Employer & \textbf{Oregon State University} \hfill Corvallis, Oregon\\
\gray Job Title & \textbf{Network Engineer}\\
\gray Languages & \textbf{Python, PHP}\\
Details& Utilizes network monitoring software such as OpenNMS, Statseeker, and perfSonar to perform network analysis and diagnostics on a large, complex university network. Works with a team of professional network engineers to perform delicate network administration tasks, such as port configuration, outage response, and performance monitoring. Independently researches, implements, and demonstrates various applications.
\end{tabularx}
...
Computer Languages & PHP, C, Python, HTML + CSS3 + JS, C++ \\
Hardware & Raspberry Pi, Minnowboard, Arduino \\
Projects & openNMS, Observium, Android
\end{tabular}
